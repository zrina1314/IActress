...
public class ImageLoader {
    ...
    public void displayImage(String uri, ImageAware imageAware, DisplayImageOptions options,
        ...
        if (TextUtils.isEmpty(uri)) {
            ...
            listener.onLoadingStarted(uri, imageAware.getWrappedView(), imageAware.getWidth(), imageAware.getHeight());
        ...
        listener.onLoadingStarted(uri, imageAware.getWrappedView(), targetSize.getWidth(), targetSize.getHeight());
